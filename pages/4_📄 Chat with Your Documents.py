...
def setup_sidebar():
    ...
    with st.sidebar:
        ...
        <div style="text-align: center; padding: 0.5rem 0; margin-bottom: 0.5rem;">
            <h3 style="color: #7df9ff; margin: 0; font-size: 1.6rem;">📄 Document Chat</h3>
            <p style="color: #b0b0ff; font-size: 0.9rem; margin: 0.3rem 0 0 0;">Chat with PDF and Text Files</p>
        </div>
        """, unsafe_allow_html=True)
        ...
        if st.session_state.document_texts:
            ...
            for doc in st.session_state.document_texts:
                ...
                <div class="uploadedFile">
                    📄 {doc['name']}<br>
                    <small style="color: #7df9ff;">{doc['size']:,} characters</small>
                </div>
                """, unsafe_allow_html=True)
...
def main():
    ...
    <div style="text-align: center; margin-bottom: 1rem;">
        <h1 style="font-size: 3rem; font-weight: 900; background: linear-gradient(90deg, #7df9ff 0%, #9370db 50%, #00ffff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin-bottom: 0.5rem; text-shadow: 0 10px 30px rgba(0, 0, 0, 0.3);">📄 Chat with Documents</h1>
        <p style="color: #b0b0ff; font-size: 1.2rem; font-weight: 300;">Upload PDF/TXT files and ask questions about their content</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if llm and st.session_state.processed_docs and st.session_state.document_texts:
                            ...
                            with st.expander("📚 Document References", expanded=False):
                                for i, result in enumerate(search_results, 1):
                                    ...
                                    <div class="doc-reference">
                                        <strong style="color: #7df9ff;">Document {i}: {result['name']}</strong><br>
                                        <div style="color: #b0b0ff; margin-top: 0.5rem;">
                                            {result['context'][:500]}...
                                        </div>
                                    </div>
                                    """, unsafe_allow_html=True)
        ...
        with col1:
            ...
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                ...
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Fast for large docs</strong></p>
        ...
        with col2:
            ...
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                ...
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Best for documents</strong></p>
                <ul style="color: #b0b0ff; padding-left: 1.2rem;">
        ...
        with col3:
            st.markdown("""
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                <h4 style="color: #7df9ff; margin-bottom: 0.8rem;">📄 PyPDF2</h4>
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Required for PDFs</strong></p>
                <ul style="color: #b0b0ff; padding-left: 1.2rem;">
                ...
                <code style="color: #7df9ff;">pip install PyPDF2</code>
            </div>
            """, unsafe_allow_html=True)
