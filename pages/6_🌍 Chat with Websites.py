...
def setup_sidebar():
    ...
    with st.sidebar:
        ...
        <div style="text-align: center; padding: 0.5rem 0; margin-bottom: 0.5rem;">
            <h3 style="color: #7df9ff; margin: 0; font-size: 1.6rem;">🌐 Website Chat</h3>
            <p style="color: #b0b0ff; font-size: 0.9rem; margin: 0.3rem 0 0 0;">Analyze Web Content</p>
        </div>
        """, unsafe_allow_html=True)
...
def main():
    ...
    <div style="text-align: center; margin-bottom: 1rem;">
        <h1 style="font-size: 3rem; font-weight: 900; background: linear-gradient(90deg, #7df9ff 0%, #9370db 50%, #00ffff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin-bottom: 0.5rem; text-shadow: 0 10px 30px rgba(0, 0, 0, 0.3);">🌐 Chat with Websites</h1>
        <p style="color: #b0b0ff; font-size: 1.2rem; font-weight: 300;">Analyze and ask questions about website content</p>
    </div>
    """, unsafe_allow_html=True)
        ...
        if successful > 0:
            ...
            <div class="website-info">
                ...
                <div style="color: #d0d0ff; line-height: 1.6;">
                    • URLs added: <strong style="color: #7df9ff;">{total}</strong><br>
                    • Successfully fetched: <strong style="color: #7df9ff;">{successful}</strong><br>
    ...
    if llm and st.session_state.websites and st.session_state.website_contents:
                            ...
                            with st.expander("📋 Website Details", expanded=False):
                                for site in successful_sites[:3]:
                                    ...
                                    <div class="website-detail">
                                        <strong style="color: #7df9ff;">{site['title']}</strong><br>
                                        <small style="color: #b0b0ff;">{site['url']}</small><br>
                                        <div style="color: #d0d0ff; margin-top: 0.5rem;">
        ...
        with col1:
            ...
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                ...
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Fast web analysis</strong></p>
        ...
        with col2:
            ...
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                ...
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Local analysis</strong></p>
                <ul style="color: #b0b0ff; padding-left: 1.2rem;">
        ...
        with col3:
            st.markdown("""
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                <h4 style="color: #7df9ff; margin-bottom: 0.8rem;">🌐 Test Websites</h4>
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Always work:</strong></p>
                <ul style="color: #b0b0ff; padding-left: 1.2rem;">
                    <li>Wikipedia (en)</li>
                    <li>Hacker News</li>
                    <li>GitHub</li>
