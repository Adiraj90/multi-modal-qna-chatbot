...
def setup_sidebar():
    ...
    with st.sidebar:
        ...
        <div style="text-align: center; padding: 0.5rem 0; margin-bottom: 0.5rem;">
            <h3 style="color: #7df9ff; margin: 0; font-size: 1.6rem;">🗄️ SQL Chat</h3>
            <p style="color: #b0b0ff; font-size: 0.9rem; margin: 0.3rem 0 0 0;">Query Databases with AI</p>
        </div>
        """, unsafe_allow_html=True)
            ...
            with st.expander("View Tables", expanded=False):
                ...
                for table in tables[:10]:  # Show first 10 tables
                    ...
                    <div class="schema-preview">
                        <strong style="color: #7df9ff;">{table}</strong><br>
                        <small style="color: #b0b0ff;">{len(cols)} columns</small>
                    </div>
                    """, unsafe_allow_html=True)
...
def main():
    ...
    <div style="text-align: center; margin-bottom: 1rem;">
        <h1 style="font-size: 3rem; font-weight: 900; background: linear-gradient(90deg, #7df9ff 0%, #9370db 50%, #00ffff 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; background-clip: text; margin-bottom: 0.5rem; text-shadow: 0 10px 30px rgba(0, 0, 0, 0.3);">🗄️ Chat with SQL Databases</h1>
        <p style="color: #b0b0ff; font-size: 1.2rem; font-weight: 300;">Query databases using natural language</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    if st.session_state.database_path and st.session_state.database_schema:
        ...
        <div class="db-info">
            ...
            <div style="color: #d0d0ff; line-height: 1.6;">
                • Database: <strong style="color: #7df9ff;">{db_name}</strong><br>
                • Tables: <strong style="color: #7df9ff;">{table_count}</strong><br>
...
Provide a brief explanation of what these results show:"""
        ...
        with col1:
            ...
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                ...
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Fast SQL generation</strong></p>
        ...
        with col2:
            ...
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                ...
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Local SQL queries</strong></p>
                <ul style="color: #b0b0ff; padding-left: 1.2rem;">
        ...
        with col3:
            st.markdown("""
            <div style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 20px; padding: 1.5rem; height: 100%; backdrop-filter: blur(10px);">
                <h4 style="color: #7df9ff; margin-bottom: 0.8rem;">🗄️ Chinook DB</h4>
                <p style="color: #d0d0ff; margin-bottom: 1rem;"><strong>Sample database</strong></p>
                <ul style="color: #b0b0ff; padding-left: 1.2rem;">
