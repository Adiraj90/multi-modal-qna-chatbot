"""
pages_shared.py - Shared utilities for all chatbot pages with improved error handling
"""
...
def extract_text(obj: Any) -> str:
    """
    Robust text extraction from various LLM response formats.
    """
    if obj is None:
        return ""
...
def get_provider_troubleshooting(provider: str) -> str:
    """
    Get troubleshooting tips for specific providers.
    """
    tips = {
        "Groq": """
